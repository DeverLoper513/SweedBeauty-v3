...
function App() {
  //Instance ID
  let InstanceId_Widget = "683649";
  let InstanceId_QA = "683660";
  let InstanceId_SEO = "683661";
  let InstanceId_Carousel = "1252621";
  let InstanceId_StarRating = "683659";
  let InstanceId_PromotedProd = "";
  let InstanceId_UgcGallery = "";
  let InstanceId_ReviewsTab = "1252620";

  //Product ID
  let ProductId = "14897380655436";
